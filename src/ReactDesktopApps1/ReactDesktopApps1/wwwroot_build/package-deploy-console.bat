...
SET TOOLS=.\tools
SET OUTPUTNAME=ReactDesktopApps1-console.exe
SET ILMERGE=%TOOLS%\ILMerge.exe
SET RELEASE=..\..\ReactDesktopApps1.AppConsole\bin\Release
SET INPUT=%RELEASE%\ReactDesktopApps1.AppConsole.exe
SET INPUT=%INPUT% %RELEASE%\ReactDesktopApps1.Resources.dll
SET INPUT=%INPUT% %RELEASE%\ReactDesktopApps1.ServiceInterface.dll
SET INPUT=%INPUT% %RELEASE%\ReactDesktopApps1.ServiceModel.dll
